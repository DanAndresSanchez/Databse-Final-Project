...
CREATE TABLE rated (
  ...
  KEY UPC (UPC),
  CONSTRAINT rated_ibfk_1 FOREIGN KEY (customerID) REFERENCES customer (customerID),
  CONSTRAINT rated_ibfk_2 FOREIGN KEY (UPC) REFERENCES product (UPC)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS top_5_products */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE PROCEDURE top_5_products()
BEGIN
select UPC, Pname, price, avg(rating) as rating, count(rating) as amount
from rated join product using (UPC)
group by UPC
...
-- Dump completed on 2020-04-26  0:35:51
